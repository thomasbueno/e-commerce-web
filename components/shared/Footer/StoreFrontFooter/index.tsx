      ...
      <Col md={{ span: 8, offset: 2 }}>
            ...
            <Row>
              ...
              <Col lg={7} md={12} className="mb-4 mb-lg-0">
                <Row className={styles.social_medias}>
                  ...
                  <Col lg={1} xs={2}>
                    <Link href="https://www.linkedin.com/in/thomas-escolastico/">
                      <a target="_blank">
        ...
        <Row>
          ...
          <Col className="text-center" lg={{ span: 6, offset: 1 }} xs={12}>
            <p style={{ 'color': 'var(--color-gray-light)' }}>thomasbuenou@gmail.com</p>
          </Col>

          <Col lg={{ span: 2, offset: 1 }} xs={{ span: 6, offset: 3 }}>
            <Image src="/assets/images/logo-bootcamp.png" alt="Logo Bootcamp" width={240} height={70} />
          </Col>
        </Row>
      </Col>
    </footer>
